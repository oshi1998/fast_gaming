...
<head>
    ...
    <title>จัดการข้อมูลเจ้าของร้าน | ระบบจัดการข้อมูลหลังบ้าน</title>
    <!-- Sweetalert -->
...
<body class="hold-transition sidebar-mini" onload="read()">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">จัดการข้อมูลเจ้าของร้าน</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">แดชบอร์ด</a></li>
                                <li class="breadcrumb-item active">จัดการข้อมูลเจ้าของร้าน</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
    ...
    <!-- Owner Function -->
    <script src="functions/owner.js"></script>
</body>
